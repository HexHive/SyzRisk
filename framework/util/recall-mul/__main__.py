...
parser.add_argument('-s', '--sc-path', type=str, \
        default='/home/gwangmu/Projects/Regression/framework/garage/data-recin/2020/commit-funcs.json')
parser.add_argument('-r', '--rc-path', type=str, \
        default='/home/gwangmu/Projects/Regression/framework/garage/data-recin/2020/rcs.json')
parser.add_argument('--ssinfo-path', type=str, \
        default='/home/gwangmu/Projects/Regression/framework/garage/data-recin/2020/commit-subsys.json')
parser.add_argument('-c', '--corr-path', type=str, \
        default='/home/gwangmu/Projects/Regression/framework/garage/data-likeli-221108/2019/sc-likeli.json')
parser.add_argument('-S', '--ss-path', type=str, \
        default='/home/gwangmu/Projects/Regression/framework/garage/data-likeli-221108/2019/ss-likeli.json')
...
def main():
    ...
    def GetCorrRank(pats, hexsha, com_funcs_size):
        ...
        for pat in pats:
            ...
            rank *= max(0, factor_0, factor, factor_ss) 
        ...
        return max(0, math.floor((-math.exp(-rank/256)+1)*256))
        #return max(0, math.floor(min(20, rank)*10))
