...
ax.text(0.12, 0.88, "5.6", fontsize=9, transform=ax.transAxes)
ax.text(0.245, 0.88, "10", fontsize=9, transform=ax.transAxes)

fig.tight_layout()

plt.savefig('risk-sc.pdf')
#plt.show()
